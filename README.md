...
Этап 16 завершён: единое руководство оператора связывает безопасный deployment/rollback, диагностику, backup/restore, удаление и privacy checklist. Dependency-free `npm test` и read-only GitHub Actions CI теперь выполняют 18 regression suites и 5 infrastructure validators. Production-версии не менялись: candidate `Build 2026.07.20.12`, admin `Build 2026.07.20.12`, backend `yandex-disk-mvp-2026-07-20-13`, deployment `@56`; API `attempt-v2`.
