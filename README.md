...
Этап 15 завершён: единая dependency-free матрица `npm test` и read-only GitHub Actions CI проверяют банки, secrets, links, JavaScript syntax и 17 regression suites. Production-версии не менялись: candidate `Build 2026.07.20.12`, admin `Build 2026.07.20.12`, backend `yandex-disk-mvp-2026-07-20-13`, deployment `@56`; API `attempt-v2`.
