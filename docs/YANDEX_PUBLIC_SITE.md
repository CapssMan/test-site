...
Статус на 8 августа 2026 года: российский статический контур опубликован и проверен, контролируемый пилот открыт. Отдельные V2 и V3 доступны только по прямым ссылкам и закрыты от поисковой индексации; V2 сохранена как контрольная версия. `SkillCheck` — временное рабочее имя.
