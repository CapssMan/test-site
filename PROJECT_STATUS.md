...
- Локально пройдены locked install и 38 проверок: 33 test-файла, 5 infrastructure validators, 240 production-вопросов без ошибок/предупреждений.
...
- Следующее техническое действие: опубликовать Admin Build 2026.07.28.1, подтвердить live-вход и YDB diagnostics, затем перенести пять закрытых банков v4. SME/legal/owner sign-off всё ещё обязательны перед открытием gates.
