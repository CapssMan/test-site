...
["fa-junior", "ca-junior", "fpa-junior", "acc-junior", "bi-junior", "tourism-junior", "software-junior", "product-project-junior"].forEach(testId => {
  assert.match(indexPage, new RegExp('href="test\\.html\\?test=' + testId + '"'), "home must retain " + testId);
});
assert.match(indexPage, /data-count="360"[^>]*>360<\//, "home must show the production bank size");
