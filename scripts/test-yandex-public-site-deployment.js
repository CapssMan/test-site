...
const expected = [
  ...
  "data/dev-quick.json", "data/fa-junior.json", "data/fpa-junior.json", "data/product-project-junior.json", "data/software-junior.json", "data/tourism-junior.json"
];
...
assert.match(deploy, /\$publicFiles\.Count -ne 25[\s\S]*Count -ne 25/);
assert.match(deploy, /exactly 25 unique files/);
...
console.log("Yandex public-site deployment checks passed: exact 25-file boundary, verified upload and Yandex-only candidate CORS.");
