...
assert.match(page, /Показываются только добровольно открытые профили/);
console.log("Employer UI checks passed: real API only, comparison-first layout, 1-10 shortlist, mobile states and no contact or mock candidate data.");
