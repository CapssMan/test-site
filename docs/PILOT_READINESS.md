...
|---|---|---|
| Реквизиты оператора | рабочий контакт `skillcheck.project@yandex.ru` внесён; владелец подтвердил входящее/исходящее письмо 24.07.2026; ФИО/наименование и адрес остаются «не указано» | владелец с профильным специалистом утверждает оставшиеся публичные реквизиты |
...
2. Защитить project email, заполнить оставшиеся реквизиты оператора, получить внешнее legal/retention решение и обновить consent version при необходимости.
