...
| Credit Analyst Junior | Работает / требует вычитки вариантов | `data/ca-junior.json` |
...
7. Перед обновлением Google Apps Script вручную создать новый deployment.
8. Не менять `SPREADSHEET_ID`, `FOLDER_ID` и Google Script URL без необходимости.
