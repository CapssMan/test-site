...
assert.match(testPage, /const FRONTEND_BUILD = "2026\.07\.31\.5"/, "candidate build must be current");
assert.match(testPage, />Build 2026\.07\.31\.5<\//, "visible candidate build must match submitted build");
