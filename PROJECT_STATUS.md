...
- Рейтинг умеет отдельное opt-in согласие, псевдоним, version-aware публикацию, российскую proof-проверку результата через `assessment-v4`/YDB, хранение только hash management token, отзыв и TTL 365 дней. Публичная база пуста, mock-профилей нет.
