...
Статус на 8 августа 2026 года: российский статический контур опубликован и проверен; после направления первичного уведомления Роскомнадзору контролируемый пилот и регистрация аккаунтов открыты. Расширенные профили и employer-контакты остаются закрыты. Отдельные V2 и V3 доступны только по прямым ссылкам и закрыты от поисковой индексации; V2 сохранена как контрольная версия. `SkillCheck` — временное рабочее имя.
