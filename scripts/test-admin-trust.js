...
function baseStore() {
  ...
  return {
    ...
    async getFeedbackByAttemptId() { return null; }, async listFeedback() { return []; },
    async listPilotAccounts() { return []; }, async listPilotAttempts() { return []; }, async listRankingProfiles() { return []; },
