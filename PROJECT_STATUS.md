...
- Production backend yandex-disk-mvp-2026-07-26-20 и Admin Build 2026.07.26.15 опубликованы: server-side sampling и расширенные TXT работают, а известные технические коды исключаются из обычной аналитики.
...
Project email создан, внесён в документы и проверен владельцем на входящее/исходящее письмо. Для завершения документов нужны утверждённые публичные формулировки полного наименования/ФИО оператора, его статуса (физлицо/ИП/юрлицо) и адреса. Дополнительно нужны независимый SME sign-off и внешнее legal/retention решение. До этого оба pilot gate остаются закрытыми.
