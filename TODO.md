...
Этап 18B завершён: российский рейтинг умеет добровольную публикацию, отзыв и TTL профиля, но реальные кандидаты остаются NO-GO. Следующий технический шаг — 18C: перенести candidate/admin write-path, отчёты и остальные retention-процессы в существующий российский контур, затем выполнить frontend cutover. Независимый SME sign-off и operator/legal/owner checklist по-прежнему обязательны до пилота. Для 18C нужен режим очень высокий.
