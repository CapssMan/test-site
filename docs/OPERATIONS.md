...
Production runtime: candidate `Build 2026.07.26.14`, admin `Build 2026.07.26.15`, backend `yandex-disk-mvp-2026-07-26-21`, deployment `@67`, API `attempt-v2`, Яндекс storage root `app:/skillcheck`.
