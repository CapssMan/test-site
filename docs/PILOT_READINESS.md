## Актуализация 31.07.2026 — content gate
...
Независимый человеческий SME review остаётся рекомендацией перед масштабированием, но не текущим блокером малой исследовательской волны. Текущий NO-GO сохраняется из-за внешнего шага владельца по Роскомнадзору и отсутствия финального owner sign-off. Технические gates: `legal_pilot_approved=false`, `attempt_issuance_enabled=false`, `retention_automation_enabled=true`.
