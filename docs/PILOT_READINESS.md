...
|---|---|---|
| Реквизиты оператора | рабочий контакт `skillcheck.project@yandex.ru` внесён; ФИО/наименование и адрес остаются «не указано» | владелец с профильным специалистом утверждает оставшиеся публичные реквизиты |
...
2. Проверить входящее/исходящее письмо project email, заполнить оставшиеся реквизиты оператора, получить внешнее legal/retention решение и обновить consent version при необходимости.
