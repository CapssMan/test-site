## Актуализация 31.07.2026 — v5

- [x] Усиленно проверить 240/240 вопросов пяти банков.
- [x] Исправить 80 методических замечаний и выпустить новые закрытые/публичные банки v5.
- [x] Подтвердить отсутствие неверных ключей, арифметических ошибок и утечки answer key.
- [ ] Решение владельца и действия по Роскомнадзору.
- [ ] После этого — короткий controlled pilot и калибровка по 10–30 фактическим прохождениям.

Повторно вычитывать неизменённые вопросы без новых данных не требуется. Независимый эксперт желателен позднее, но для малой исследовательской пилотной волны не является обязательным текущим блокером.
# TODO.md
...
- [x] Опубликовать ФИО оператора и project email; статус НПД и регион не публиковать как избыточные.
- [ ] Утвердить с профильным специалистом полный публичный адрес оператора и заменить оставшуюся явную заглушку.
- [x] Указать и проверить реальный email для запросов по персональным данным в обоих документах.
...
- [x] Спроектировать version-aware ranking без сравнения несопоставимых банков и ложной точности малой выборки.
